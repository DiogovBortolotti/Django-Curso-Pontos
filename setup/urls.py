...
"""
# gambiarra para mostrar as fotos em desenvolvimento
...
router.register('pontoturistisco', PontoTuristicoViewSet,
...
router.register('avaliacoes', AvaliacoesViewSets)

urlpatterns = [
    path('', include(router.urls)),
    path('admin/', admin.site.urls),
    path('api-token-auth/', obtain_auth_token)
] + static(settings.MEDIA_URL, document_root=settings.MEDIA_ROOT)  # GAMBIARRA DE FOTOS
